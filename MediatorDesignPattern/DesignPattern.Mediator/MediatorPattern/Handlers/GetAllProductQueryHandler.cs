...
namespace DesignPattern.Mediator.MediatorPattern.Handlers
{
    public class GetAllProductQueryHandler : IRequestHandler<GetAllProductQuery, List<GetAllProductQueryResult>>
    {
        ...
        //CancelationToken => Sayfa yüklenirken çok uzun sürdüğünde sayfa kapatılma sırasında işlem iptal edilsinmi iptal edilmesinmi görevini görür ama burada kullanmıcaz.
